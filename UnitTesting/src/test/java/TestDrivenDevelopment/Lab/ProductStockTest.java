...
public class ProductStockTest {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void testFindFirstMostExpensiveProductsShouldThrowExceptionWhenCountIsMoreThanProductsInTheCollection() {
        addProducts();
        instock.findFirstMostExpensiveProducts(instock.getCount() + 1);
    }
